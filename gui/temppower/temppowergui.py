...
class ConfocalGui(GUIBase):
    ...
    # declare connectors
    confocallogic2 = Connector(interface='TempPowerLogic')
    savelogic = Connector(interface='SaveLogic')
    optimizerlogic2 = Connector(interface='OptimizerLogic')
    ...
    def on_activate(self):
        ...
        self._scanning_logic = self.confocallogic2()
        self._save_logic = self.savelogic()
        self._optimizer_logic = self.optimizerlogic2()
