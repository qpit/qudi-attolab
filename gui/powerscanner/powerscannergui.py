# -*- coding: utf-8 -*-
"""
This file contains the Qudi GUI module to operate the voltage (power) scanner.
...
class VoltScanMainWindow(QtWidgets.QMainWindow):
    def __init__(self):
        ...
        ui_file = os.path.join(this_dir, 'ui_powerscannergui.ui')
...
class VoltScanGui(GUIBase):
    ...
    # declare connectors
    voltagescannerlogic1 = Connector(interface='PowerScannerLogic')
